-- PostgreSQL mirror of SQLite 0035. Reservations are committed before remote
-- HTTP; incomplete rows therefore remain explicitly unknown_completion.
CREATE TABLE IF NOT EXISTS processing_provider_attempts (
    ...
    canonicalized BOOLEAN NOT NULL DEFAULT false,
...
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS job_uuid TEXT;
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS contract_hash TEXT;
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS profile_fingerprint TEXT;
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS canonicalized BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS attempt_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE processing_stage_runs ADD COLUMN IF NOT EXISTS total_provider_latency_ms INTEGER NOT NULL DEFAULT 0;
