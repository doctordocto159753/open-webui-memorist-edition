ALTER TABLE memory_processing_runs ADD COLUMN model_role TEXT;
ALTER TABLE memory_processing_runs ADD COLUMN model_name TEXT;
ALTER TABLE memory_processing_runs ADD COLUMN processing_identity_hash TEXT;
...
ALTER TABLE import_message_processing_status ADD COLUMN prompt_id TEXT;
ALTER TABLE import_message_processing_status ADD COLUMN prompt_version TEXT;
