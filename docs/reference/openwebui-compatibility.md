...
The release gate is contract-based: it runs the Memorist payload parser, inlet/outlet lifecycle tests, fail-open tests, idempotency tests, fixture payloads, and model control plane tests. A full Open WebUI version matrix is not claimed for v0.2.0-beta.2.
